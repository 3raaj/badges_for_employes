...
class LoginSuccess extends LoginState {
  ...
  LoginSuccess(bool isClientLoginMode, {required this.user, this.employesList}):super(isClientLoginMode);
}

class LoginFailed extends LoginState {
  final String loginExceptionMessage;
  LoginFailed(bool  isClientLoginMode, {required this.loginExceptionMessage}):super(isClientLoginMode);
}
